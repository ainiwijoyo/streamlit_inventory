...
def pengaturan_akun():
    ...
    if option == "Tambah Akun":
        ...
        if st.button("Edit Akun"):
            ...
            elif password_baru == password_sekarang:
                st.error("Password baru tidak boleh sama dengan password sekarang")
            else:
        ...
        if st.button("Hapus Akun"):
            ...
            if st.session_state.hapus_konfirmasi:
                ...
                if jenis_user == "superadmin":
                    ...
                    st.warning(f"Yakin ingin menghapus akun ini: {user_selected}?")
